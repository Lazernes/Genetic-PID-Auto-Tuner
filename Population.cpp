...
void Population::crossing() {
    ...
    std::uniform_int_distribution<int> int_dist0(0, (int)population_copy.size() - 1);
    std::uniform_int_distribution<int> int_dist1(0, (int)population_copy.size() - 1);
    while (population_copy.size() > 1) {                                      // creating random pairs
        // first pair member
